...
```shell
git clone https://github.com/jlcarrascof/Vet-clinic-database.git
cd Vet-clinic-database
```

### Install
Install the PostgreSQL RDBMS.


### Usage
Start PostgreSQL RDBMS in your computer.
...
- Add any suggestions received from collaborators
